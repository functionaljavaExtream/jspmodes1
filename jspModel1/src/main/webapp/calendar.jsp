...
<%
	...
	int month = cal.get(Calendar.MONTH)+1; // +1을 꼭 해주어야 한다.
	...
	String pp = String.format("<a href='calendar.jsp?year=%d&month=%d'>"
							 + "  <img src='img/left.gif' width='20px' height='20px'>"
							+ "</a>", 					year-1, month);
	
	// < month--
	String p = String.format("<a href='calendar.jsp?year=%d&month=%d'>"
							 + "  <img src='img/prec.gif' width='20px' height='20px'>"
							+ "</a>", 					year, month-1);
	
	// > month++
	String n = String.format("<a href='calendar.jsp?year=%d&month=%d'>"
							 + "  <img src='img/next.gif' width='20px' height='20px'>"
							+ "</a>", 					year, month+1);
	
	// >> year++
	String nn = String.format("<a href='calendar.jsp?year=%d&month=%d'>"
			 				+ "  <img src='img/last.gif' width='20px' height='20px'>"
						   + "</a>", 					year+1, month);
